...
At its heart, a neural network is simply a set of mathematical functions, theory in code. Neural nets only come "alive" in the presence of data.
...
What defines a good dataset? The answer is "it depends".

Usually, more data is better. But if you're working on a problem that is well understood and well solved, you'll need less. If you're working on a fairly novel problem, you'll need more. If you're working on some exotic data form, you'll need even more.

There are three things you'll want to keep in mind when gathering data: your dataset should be **representative**, it should be **well-balanced**, and it should be **shuffled**.

Let's examine each of these.

### Representative
It is important that the dataset you use to train your network be *as similar as possible* to the data the network will be predicting upon. That is, it is **representative** of the eventual dataset used for prediction.
If your training data consists of well-lit data like:
